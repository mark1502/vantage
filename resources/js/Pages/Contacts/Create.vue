                    ...
                    <!-- Address Line starts-->
                        <div class="flex my-5">
                            <div class="flex-col w-1/2 max-w-sm">
                                ...
                                <textarea v-model="form.address" id="form.address" class="textarea textarea-bordered p-2 h-32 w-full"></textarea>
                    ...
                    <!--Notes Line and Buttons-->
                        <div class="flex mt-6 items-end">
                            <div class="flex-col w-2/3">
                                ...
                                <textarea v-model="form.note" id="formnotes" class="textarea textarea-bordered p-2 w-full" rows="4"></textarea>
